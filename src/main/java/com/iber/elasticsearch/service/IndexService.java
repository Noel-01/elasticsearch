...
import com.iber.elasticsearch.helper.Utils;
...
public class IndexService {
    ...
    private final @Qualifier("client")       RestHighLevelClient client;
    ...
    public void recreateIndices(final boolean deleteExisting) {
        final var settings = Utils.loadAsString("static/es-settings.json");
    ...
    private String loadMappings(String indexName) {
        ...
        final var mappings = Utils.loadAsString("static/mappings/" + indexName + ".json");
